...
public class Lienzo {
    ...
    float Rotation=0;
    float RotationParent=0;
    float RotationRelative=0;


    float xPositionRelative=0;
    float yPositionRelative=0;
    float xPositionParent=0;
    float yPositionParent=0;
    float xPosition=0;
    float yPosition=0;
    float xPositionBefore=0;
    float yPositionBefore=0;
    ...
    public float getXBasePosition(){return  xPosition;}//posicion base
    public float getYBasePosition(){return yPosition;}
    public float getXPosition(){return xPosition+xPositionParent;} //obtiene posicion casi real
    public float getYPosition(){return yPosition+yPositionParent;}
    public float getXPositionAbsolute(){return getXPosition()+xPositionRelative;}//posicion absoluta
    public float getYPositionAbsolute(){return getYPosition()+yPositionRelative;}

    //rotacion
    public void setRotationAngle(float angle){Rotation=angle;}
    public void setRotationParent(float angle){RotationParent=angle;}
    public void setRotationRelative(float angle){RotationRelative=angle;}
    public float getRotation(){return Rotation+RotationParent;}
    public float getRotationAbsolute(){return Rotation+RotationParent+RotationRelative;}

    public int getWidht(){return bitmap.getWidth()/2;}
    public int getHeight(){return bitmap.getHeight()/2;}
   ...
   /* public void drawBitmap6(Bitmap bitmap){
    ...
    //    Rect rectangle = new Rect(50,50,100,100);//para recortar y medida
       ...
       // canvas.draw
       // canvas.drawBitmap(bitmap,x*2,y*2, paint_mode);
        BitmapUtil.drawBitmap(canvas,bitmap,x*2,y*2,getRotation(),paint_mode);
    ...
    private void drawSpriteTemp(){
        if(bitmapSpriteTemp!=null){
            drawBitmap(bitmapSpriteTemp,0,0);
        }
    }
    private void drawSpriteOnly(){
        if(spriteOnly!=null){
            drawBitmap(spriteOnly,0,0);
        }
    }
