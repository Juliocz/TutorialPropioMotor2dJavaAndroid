...
public class GameObject extends Lienzo {
    ...
    private void aplicPositionParent(){
        if(parent==null)return;
            ...
            yPositionParent=parent.yPosition;
            xPositionParent=parent.xPosition;
        }
    }
    ...
    private void aplicPositionCamera(){
        if(camera==null)return;
            ...
            camera.cameraXPositionParent=xPosition;
            camera.cameraYPositionParent=yPosition;
    ...
    public boolean isColisionWith(GameObject gameObject1,GameObject gameObject2){
        ...
        if(gameObject1.colision==null || gameObject2.colision==null)return false;//retorna false si uno de los objetos tiene colision nula
            ...
            return Colision.isColision(Colision.getTemp(gameObject1.colision,gameObject1.xPosition+gameObject1.xPositionParent,gameObject1.yPosition+gameObject1.yPositionParent),
                    Colision.getTemp(gameObject2.colision,gameObject2.xPosition+gameObject2.xPositionParent,gameObject2.yPosition+gameObject2.yPositionParent));
        }
    }
